    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthday', models.DateField(blank=True, null=True, validators=[account.models.MyAccountManager.validate_birthday], verbose_name='Дата рождения')),
                ('role', models.CharField(choices=[('not_role', 'Роль не определена'), ('base', 'База')], default='not_role', max_length=10)),
                ('position', models.CharField(choices=[('junior', 'Junior'), ('middle', 'Middle'), ('senior', 'Senior')], default='junior', max_length=10)),
